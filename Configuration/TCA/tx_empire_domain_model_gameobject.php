...
return [
	...
	'columns' => [
		...
		'fqcn' => [
			'exclude' => true,
			'label' => 'LLL:EXT:empire/Resources/Private/Language/locallang_tca.xlf:tx_empire_domain_model_gameobject.fqcn',
			'config' => [
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'properties' => [
			'exclude' => true,
			'label' => 'LLL:EXT:empire/Resources/Private/Language/locallang_tca.xlf:tx_empire_domain_model_gameobject.properties',
			'config' => [
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
